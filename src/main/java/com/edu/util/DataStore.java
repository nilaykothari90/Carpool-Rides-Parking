...
public class DataStore {
	...
	private static void initializeFrequestRideList() {
		...
		String source2 = "PaloAlto", destin2 = "SanFrancisco";
	...
	private static void initializePassengers() {
		try {
			String line = null;
			String fileName = "config/Passenger";
	...
	private static void intializeGarageList() {
		garageList.add(new Garage(1, "GarageA", "SanFrancisco", "08/14/2016", 9.0f, 11.0f, 15.0f));
		garageList.add(new Garage(2, "GarageB", "SanMateo", "08/16/2016", 8.0f, 5.0f, 40.0f));
		garageList.add(new Garage(3, "GarageA", "Hayward", "08/18/2016", 9.0f, 12.0f, 20.0f));
		garageList.add(new Garage(4, "GarageA", "Fremont", "08/19/2016", 7.0f, 11.0f, 50.0f));
	}

	private static void intializeDrivers() {
		try {
			String line = null;
			String fileName = "config/Driver";
			FileReader fileReader = new FileReader(fileName);
			BufferedReader bufferedReader = new BufferedReader(fileReader);
			while ((line = bufferedReader.readLine()) != null) {
